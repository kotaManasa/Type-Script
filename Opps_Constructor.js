var students = /** @class */ (function () {
    function students(studentid, studentname, studentmarks) {
        if (studentid === void 0) { studentid = 10; }
        if (studentname === void 0) { studentname = "Kothi"; }
        if (studentmarks === void 0) { studentmarks = 60; }
